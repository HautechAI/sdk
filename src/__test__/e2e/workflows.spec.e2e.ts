...
describe('Workflows API E2E Tests', () => {
    ...
    describe('Workflows CRUD Operations', () => {
        ...
        it('should update a workflow', async () => {
            expect(createdWorkflowId).toBeDefined();
            const current = await sdk.workflows.get(createdWorkflowId);
    ...
    describe('Public Workflows', () => {
        ...
        let sharedWorkflowAlias: string;
        ...
        beforeAll(async () => {
            const workflowData = {
                ...
                alias: randomUUID(),
                pipelineTemplate: { tasks: [], output: { id: 'output' } },
            };

            const result = await sdk.workflows.create(workflowData);
            sharedWorkflowId = result.id;
            sharedWorkflowAlias = result.alias;
        ...
        it('should run a public workflow by alias', async () => {
            const runParams = {
                input: {
                    testInput: 'test-value',
                },
            ...
            const result = await sdk.workflows.runPublicByAlias(sharedWorkflowAlias, runParams);
            expect(result).toBeDefined();
            expect(result.operationId).toBeDefined();
            expect(typeof result.operationId).toBe('string');

            const data = await sdk.operations.waitById(result.operationId);
