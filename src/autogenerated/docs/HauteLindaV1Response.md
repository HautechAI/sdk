...
**output** | [**OperationOutputImageMultiple**](OperationOutputImageMultiple.md) |  | [default to undefined]
...
```typescript
import { HauteLindaV1Response } from './api';

const instance: HauteLindaV1Response = {
    kind,
    output,
    input,
    status,
