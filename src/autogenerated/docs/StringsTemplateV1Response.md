...
**output** | [**OperationOutputTextSingle**](OperationOutputTextSingle.md) |  | [default to undefined]
...
```typescript
import { StringsTemplateV1Response } from './api';

const instance: StringsTemplateV1Response = {
    kind,
    output,
    input,
    status,
