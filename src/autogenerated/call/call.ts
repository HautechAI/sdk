...
const callControllerCallAccessGrantV1 = (
 ...
 options?: SecondParameter<typeof axiosMutator>,) => {
  ...
  const callControllerCallOperationsRunLoraTrainingV1 = (
    loraTrainingRequest: LoraTrainingRequest,
 options?: SecondParameter<typeof axiosMutator>,) => {
      return axiosMutator<LoraTrainingResponse>(
      {url: `/v1/call/operations.run.lora.training`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
...
export type CallControllerCallOperationsRunLoraTrainingV1Result = NonNullable<Awaited<ReturnType<ReturnType<typeof getCall>['callControllerCallOperationsRunLoraTrainingV1']>>>
