...
const callControllerCallAccessGrantV1 = (
 ...
 options?: SecondParameter<typeof axiosMutator>,) => {
  ...
  const callControllerCallOperationsRunImagesConvertFormatV1V1 = (
    imagesConvertFormatV1Request: ImagesConvertFormatV1Request,
 options?: SecondParameter<typeof axiosMutator>,) => {
      return axiosMutator<ImagesConvertFormatV1Response>(
      {url: `/v1/call/operations.run.images.convert_format.v1`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
 ...
 options?: SecondParameter<typeof axiosMutator>,) => {
  ...
  const callControllerCallOperationsRunEditFlux2KleinV1V1 = (
    editFlux2KleinV1Request: EditFlux2KleinV1Request,
 options?: SecondParameter<typeof axiosMutator>,) => {
      return axiosMutator<EditFlux2KleinV1Response>(
      {url: `/v1/call/operations.run.edit.flux2_klein.v1`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
...
export type CallControllerCallOperationsRunImagesConvertFormatV1V1Result = NonNullable<Awaited<ReturnType<ReturnType<typeof getCall>['callControllerCallOperationsRunImagesConvertFormatV1V1']>>>
...
export type CallControllerCallOperationsRunEditFlux2KleinV1V1Result = NonNullable<Awaited<ReturnType<ReturnType<typeof getCall>['callControllerCallOperationsRunEditFlux2KleinV1V1']>>>
