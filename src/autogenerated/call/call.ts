...
const callControllerCallAccessGrantV1 = (
 ...
 options?: SecondParameter<typeof axiosMutator>,) => {
  ...
  const callControllerCallOperationsRunFluxKontextPrepareDatasetV1V1 = (
 ...
 options?: SecondParameter<typeof axiosMutator>,) => {
      ...
      {url: `/v1/call/operations.run.flux.kontext.prepare_dataset.v1`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: fluxKontextPrepareDatasetV1Request
    },
      options);
    }
  const callControllerCallOperationsRunFluxKontextTrainV1V1 = (
    fluxKontextTrainV1Request: FluxKontextTrainV1Request,
 options?: SecondParameter<typeof axiosMutator>,) => {
      return axiosMutator<FluxKontextTrainV1Response>(
      {url: `/v1/call/operations.run.flux.kontext.train.v1`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
      data: fluxKontextTrainV1Request
    },
      options);
    }
  const callControllerCallOperationsRunFluxKontextV1V1 = (
    fluxKontextV1Request: FluxKontextV1Request,
 options?: SecondParameter<typeof axiosMutator>,) => {
      return axiosMutator<FluxKontextV1Response>(
      {url: `/v1/call/operations.run.flux.kontext.v1`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
...
export type CallControllerCallOperationsRunFluxKontextPrepareDatasetV1V1Result = NonNullable<Awaited<ReturnType<ReturnType<typeof getCall>['callControllerCallOperationsRunFluxKontextPrepareDatasetV1V1']>>>
export type CallControllerCallOperationsRunFluxKontextTrainV1V1Result = NonNullable<Awaited<ReturnType<ReturnType<typeof getCall>['callControllerCallOperationsRunFluxKontextTrainV1V1']>>>
export type CallControllerCallOperationsRunFluxKontextV1V1Result = NonNullable<Awaited<ReturnType<ReturnType<typeof getCall>['callControllerCallOperationsRunFluxKontextV1V1']>>>
