...
export type CurrentAccessControllerDtoRelationsItem = typeof CurrentAccessControllerDtoRelationsItem[keyof typeof CurrentAccessControllerDtoRelationsItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CurrentAccessControllerDtoRelationsItem = {
  owner: 'owner',
