...
export type ModifyAccessParamsDtoAccess = typeof ModifyAccessParamsDtoAccess[keyof typeof ModifyAccessParamsDtoAccess];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ModifyAccessParamsDtoAccess = {
  owner: 'owner',
