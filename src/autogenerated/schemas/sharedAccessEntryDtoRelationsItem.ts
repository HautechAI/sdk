...
export type SharedAccessEntryDtoRelationsItem = typeof SharedAccessEntryDtoRelationsItem[keyof typeof SharedAccessEntryDtoRelationsItem];


// eslint-disable-next-line @typescript-eslint/no-redeclare
export const SharedAccessEntryDtoRelationsItem = {
  owner: 'owner',
